package com.highlevel.flutter_twilio_voice.flutter_twilio_voice.AppRtc;
...
import com.highlevel.flutter_twilio_voice.flutter_twilio_voice.R;
...
public class AppRTCAudioManager {
    ...
    public void toggleBluetooth(boolean onBluetooth) {
        if (onBluetooth) {
    ...
    public String getBluetoothName() {
        ThreadUtils.checkIsOnMainThread();
        return bluetoothManager.updateDevice();
    ...
    public void setBluetoothPhoneOn(boolean on) {
        boolean wasOn = bluetoothManager.isScoOn();
        if (wasOn == on) {
            return;
        }
    ...
    public boolean isBluetoothOn() {
        return bluetoothManager.isScoOn();
    }
